...
function MenuLine(props) {
  ...
  return (
    <div className={menuline.menu_div} id="content_menu_div">  
      <div className={menuline.menu_item_click} onClick={onMenuItemClick.bind(this)} id="i1">Merchant Name </div> 
      <div className={menuline.menu_item_div} onClick={onMenuItemClick.bind(this)} id="i2"> Merchant Address  </div>  
